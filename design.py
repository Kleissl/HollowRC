...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.moveUpRowButton.setIcon(icon2)
        ...
        self.moveDownRowButton.setIcon(icon3)
